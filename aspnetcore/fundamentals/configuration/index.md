...
* <span data-ttu-id="52a6a-107">Arquivos de configurações, como *:::no-loc(appsettings.json):::*</span><span class="sxs-lookup"><span data-stu-id="52a6a-107">Settings files, such as *:::no-loc(appsettings.json):::*</span></span>
...
1. <span data-ttu-id="52a6a-123">[:::no-loc(appsettings.json):::](#appsettingsjson) usando o [provedor de configuração JSON](#file-configuration-provider).</span><span class="sxs-lookup"><span data-stu-id="52a6a-123">[:::no-loc(appsettings.json):::](#appsettingsjson) using the [JSON configuration provider](#file-configuration-provider).</span></span>
...
<span data-ttu-id="52a6a-129">Os provedores de configuração adicionados posteriormente substituem as configurações de chave anteriores.</span><span class="sxs-lookup"><span data-stu-id="52a6a-129">Configuration providers that are added later override previous key settings.</span></span> <span data-ttu-id="52a6a-130">Por exemplo, se `MyKey` for definido no *:::no-loc(appsettings.json):::* e no ambiente, o valor do ambiente será usado.</span><span class="sxs-lookup"><span data-stu-id="52a6a-130">For example, if `MyKey` is set in both *:::no-loc(appsettings.json):::* and the environment, the environment value is used.</span></span> <span data-ttu-id="52a6a-131">Usando os provedores de configuração padrão, o  [provedor de configuração de linha de comando](#clcp) substitui todos os outros provedores.</span><span class="sxs-lookup"><span data-stu-id="52a6a-131">Using the default configuration providers, the  [Command-line configuration provider](#clcp) overrides all other providers.</span></span>
...
<span data-ttu-id="52a6a-134">Considere o seguinte *:::no-loc(appsettings.json):::* arquivo:</span><span class="sxs-lookup"><span data-stu-id="52a6a-134">Consider the following *:::no-loc(appsettings.json):::* file:</span></span>
...
<span data-ttu-id="52a6a-140">*appSettings* . `Environment` . valores *JSON* substituem chaves em *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-140">*appsettings* .`Environment`. *json* values override keys in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="52a6a-141">Por exemplo, por padrão:</span><span class="sxs-lookup"><span data-stu-id="52a6a-141">For example, by default:</span></span>

* <span data-ttu-id="52a6a-142">Em desenvolvimento, *appSettings* . \* **desenvolvimento** _._json \* a configuração substitui os valores encontrados em *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-142">In development, *appsettings* .\* **Development** _._json\* configuration overwrites values found in *:::no-loc(appsettings.json):::* .</span></span>
* <span data-ttu-id="52a6a-143">Em produção, *appSettings* . \* _._Json de **produção** \* a configuração substitui os valores encontrados em *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-143">In production, *appsettings* .\* **Production** _._json\* configuration overwrites values found in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="52a6a-144">Por exemplo, ao implantar o aplicativo no Azure.</span><span class="sxs-lookup"><span data-stu-id="52a6a-144">For example, when deploying the app to Azure.</span></span>
...
<span data-ttu-id="52a6a-146">Usando a configuração [padrão](#default) , o *:::no-loc(appsettings.json):::* e *appSettings.* `Environment` os arquivos *. JSON* são habilitados com [reloadOnChange: true](https://github.com/dotnet/extensions/blob/release/3.1/src/Hosting/Hosting/src/Host.cs#L74-L75).</span><span class="sxs-lookup"><span data-stu-id="52a6a-146">Using the [default](#default) configuration, the *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* files are enabled with [reloadOnChange: true](https://github.com/dotnet/extensions/blob/release/3.1/src/Hosting/Hosting/src/Host.cs#L74-L75).</span></span> <span data-ttu-id="52a6a-147">As alterações feitas no *:::no-loc(appsettings.json):::* e *appSettings.* `Environment` o arquivo *. JSON* \* **após** _, o aplicativo iniciado é lido pelo [provedor de configuração JSON](#jcp).</span><span class="sxs-lookup"><span data-stu-id="52a6a-147">Changes made to the *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* file \* **after** _ the app starts are read by the [JSON configuration provider](#jcp).</span></span>
...
<span data-ttu-id="52a6a-156">Por [padrão](#default), o [Gerenciador de segredo](xref:security/app-secrets) lê as definições de configuração após *:::no-loc(appsettings.json):::* e *appSettings.* `Environment` *. JSON* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-156">By [default](#default), [Secret manager](xref:security/app-secrets) reads configuration settings after *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* .</span></span>
...
<span data-ttu-id="52a6a-163">Usando a configuração [padrão](#default) , o <xref:Microsoft.Extensions.Configuration.EnvironmentVariables.EnvironmentVariablesConfigurationProvider> carrega a configuração de pares chave-valor da variável de ambiente após a leitura *:::no-loc(appsettings.json):::* , *appSettings.* `Environment` *. JSON* e o [Gerenciador de segredo](xref:security/app-secrets).</span><span class="sxs-lookup"><span data-stu-id="52a6a-163">Using the [default](#default) configuration, the <xref:Microsoft.Extensions.Configuration.EnvironmentVariables.EnvironmentVariablesConfigurationProvider> loads configuration from environment variable key-value pairs after reading *:::no-loc(appsettings.json):::* , *appsettings.*`Environment`*.json* , and [Secret manager](xref:security/app-secrets).</span></span> <span data-ttu-id="52a6a-164">Portanto, os valores de chave lidos dos valores de substituição de ambiente lidos de *:::no-loc(appsettings.json):::* , *appSettings.* `Environment` *. JSON* e o Gerenciador de segredo.</span><span class="sxs-lookup"><span data-stu-id="52a6a-164">Therefore, key values read from the environment override values read from *:::no-loc(appsettings.json):::* , *appsettings.*`Environment`*.json* , and Secret manager.</span></span>
...
<span data-ttu-id="52a6a-176">Para testar se os comandos anteriores substituem *:::no-loc(appsettings.json):::* e *appSettings.* `Environment` *. JSON* :</span><span class="sxs-lookup"><span data-stu-id="52a6a-176">To test that the preceding commands override *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* :</span></span>
...
* <span data-ttu-id="52a6a-200">*:::no-loc(appsettings.json):::* e *appSettings* . `Environment` . arquivos *JSON* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-200">*:::no-loc(appsettings.json):::* and *appsettings* .`Environment`. *json* files.</span></span>
...
<span data-ttu-id="52a6a-230">O [download de exemplo](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/fundamentals/configuration/index/samples/3.x/ConfigSample) contém o seguinte  *:::no-loc(appsettings.json):::* arquivo:</span><span class="sxs-lookup"><span data-stu-id="52a6a-230">The [sample download](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/fundamentals/configuration/index/samples/3.x/ConfigSample) contains the following  *:::no-loc(appsettings.json):::* file:</span></span>
...
* <span data-ttu-id="52a6a-336">Substituir as configurações no *:::no-loc(appsettings.json):::* e *appSettings* . `Environment` . arquivos *JSON* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-336">Override settings in the *:::no-loc(appsettings.json):::* and *appsettings* .`Environment`. *json* files.</span></span>
...
## <a name="access-configuration-in-no-locrazor-pages"></a><span data-ttu-id="52a6a-437">Configuração de acesso em :::no-loc(Razor)::: páginas</span><span class="sxs-lookup"><span data-stu-id="52a6a-437">Access configuration in :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="52a6a-438">O código a seguir exibe os dados de configuração em uma :::no-loc(Razor)::: página:</span><span class="sxs-lookup"><span data-stu-id="52a6a-438">The following code displays configuration data in a :::no-loc(Razor)::: Page:</span></span>
...
<span data-ttu-id="52a6a-440">A marcação a seguir usa a [`@inject`](xref:mvc/views/razor#inject) :::no-loc(Razor)::: diretiva para resolver e exibir os valores de opções:</span><span class="sxs-lookup"><span data-stu-id="52a6a-440">The following markup uses the [`@inject`](xref:mvc/views/razor#inject) :::no-loc(Razor)::: directive to resolve and display the options values:</span></span>
...
<span data-ttu-id="52a6a-449">No exemplo anterior, os valores de `Option1` e `Option2` são especificados em *:::no-loc(appsettings.json):::* e, em seguida, substituídos pelo delegado configurado.</span><span class="sxs-lookup"><span data-stu-id="52a6a-449">In the preceding example, the values of `Option1` and `Option2` are specified in *:::no-loc(appsettings.json):::* and then overridden by the configured delegate.</span></span>
...
* <span data-ttu-id="52a6a-520">A configuração do aplicativo é fornecida de:</span><span class="sxs-lookup"><span data-stu-id="52a6a-520">App configuration is provided from:</span></span>
  * <span data-ttu-id="52a6a-521">*:::no-loc(appsettings.json):::* usando o [provedor de configuração de arquivo](#file-configuration-provider).</span><span class="sxs-lookup"><span data-stu-id="52a6a-521">*:::no-loc(appsettings.json):::* using the [File Configuration Provider](#file-configuration-provider).</span></span>
...
<span data-ttu-id="52a6a-553"><xref:Microsoft.Extensions.Configuration.IConfiguration> está disponível no contêiner [DI (injeção de dependência)](xref:fundamentals/dependency-injection) do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="52a6a-553"><xref:Microsoft.Extensions.Configuration.IConfiguration> is available in the app's [dependency injection (DI)](xref:fundamentals/dependency-injection) container.</span></span> <span data-ttu-id="52a6a-554"><xref:Microsoft.Extensions.Configuration.IConfiguration> pode ser injetado em uma :::no-loc(Razor)::: página <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> ou MVC <xref:Microsoft.AspNetCore.Mvc.Controller> para obter a configuração da classe.</span><span class="sxs-lookup"><span data-stu-id="52a6a-554"><xref:Microsoft.Extensions.Configuration.IConfiguration> can be injected into a :::no-loc(Razor)::: Pages <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> or MVC <xref:Microsoft.AspNetCore.Mvc.Controller> to obtain configuration for the class.</span></span>
...
1. <span data-ttu-id="52a6a-601">Arquivos ( *:::no-loc(appsettings.json):::* , *appSettings. { Ambiente}. JSON* , em que `{Environment}` é o ambiente de hospedagem atual do aplicativo)</span><span class="sxs-lookup"><span data-stu-id="52a6a-601">Files ( *:::no-loc(appsettings.json):::* , *appsettings.{Environment}.json* , where `{Environment}` is the app's current hosting environment)</span></span>
...
* <span data-ttu-id="52a6a-626">Configuração opcional de *:::no-loc(appsettings.json):::* e *appSettings. { Arquivos. JSON do ambiente}* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-626">Optional configuration from *:::no-loc(appsettings.json):::* and *appsettings.{Environment}.json* files.</span></span>
...
* <span data-ttu-id="52a6a-684">Configuração opcional de *:::no-loc(appsettings.json):::* e *appSettings. { Arquivos. JSON do ambiente}* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-684">Optional configuration from *:::no-loc(appsettings.json):::* and *appsettings.{Environment}.json* files.</span></span>
...
* <span data-ttu-id="52a6a-764">*:::no-loc(appsettings.json):::* : Este arquivo é lido primeiro.</span><span class="sxs-lookup"><span data-stu-id="52a6a-764">*:::no-loc(appsettings.json):::* : This file is read first.</span></span> <span data-ttu-id="52a6a-765">A versão de ambiente do arquivo pode substituir os valores fornecidos pelo *:::no-loc(appsettings.json):::* arquivo.</span><span class="sxs-lookup"><span data-stu-id="52a6a-765">The environment version of the file can override the values provided by the *:::no-loc(appsettings.json):::* file.</span></span>
...
<span data-ttu-id="52a6a-774">Chame `ConfigureAppConfiguration` ao compilar o host para especificar a configuração do aplicativo para arquivos diferentes de *:::no-loc(appsettings.json):::* e *appSettings. { Ambiente}. JSON* :</span><span class="sxs-lookup"><span data-stu-id="52a6a-774">Call `ConfigureAppConfiguration` when building the host to specify the app's configuration for files other than *:::no-loc(appsettings.json):::* and *appsettings.{Environment}.json* :</span></span>
...
* <span data-ttu-id="52a6a-777">A primeira chamada para `AddJsonFile` carrega a configuração de *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="52a6a-777">The first call to `AddJsonFile` loads configuration from *:::no-loc(appsettings.json):::* :</span></span>
...
1. <span data-ttu-id="52a6a-788">As configurações no *appsettings.Development.js* não substituem mais as configurações em *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="52a6a-788">The settings in the *appsettings.Development.json* no longer override the settings in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="52a6a-789">O nível de log para a chave `Logging:LogLevel:Default` é `Warning` .</span><span class="sxs-lookup"><span data-stu-id="52a6a-789">The log level for the key `Logging:LogLevel:Default` is `Warning`.</span></span>
...
## <a name="access-configuration-in-a-no-locrazor-pages-page-or-mvc-view"></a><span data-ttu-id="52a6a-995">Acessar a configuração em uma :::no-loc(Razor)::: página de páginas ou exibição do MVC</span><span class="sxs-lookup"><span data-stu-id="52a6a-995">Access configuration in a :::no-loc(Razor)::: Pages page or MVC view</span></span>

<span data-ttu-id="52a6a-996">Para acessar as definições de configuração em uma :::no-loc(Razor)::: página de páginas ou em uma exibição do MVC, adicione uma [diretiva using](xref:mvc/views/razor#using) ([referência C#: usando diretiva](/dotnet/csharp/language-reference/keywords/using-directive)) para o [ namespaceMicrosoft.Extensions.Configuração](xref:Microsoft.Extensions.Configuration) e insira <xref:Microsoft.Extensions.Configuration.IConfiguration> na página ou exibição.</span><span class="sxs-lookup"><span data-stu-id="52a6a-996">To access configuration settings in a :::no-loc(Razor)::: Pages page or an MVC view, add a [using directive](xref:mvc/views/razor#using) ([C# reference: using directive](/dotnet/csharp/language-reference/keywords/using-directive)) for the [Microsoft.Extensions.Configuration namespace](xref:Microsoft.Extensions.Configuration) and inject <xref:Microsoft.Extensions.Configuration.IConfiguration> into the page or view.</span></span>

<span data-ttu-id="52a6a-997">Em uma :::no-loc(Razor)::: página de páginas:</span><span class="sxs-lookup"><span data-stu-id="52a6a-997">In a :::no-loc(Razor)::: Pages page:</span></span>
