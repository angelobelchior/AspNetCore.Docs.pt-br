...
<span data-ttu-id="36109-145"><xref:Microsoft.AspNetCore.Http.Features.IRequest:::no-loc(Cookie):::sFeature>: Analisa e armazena em cache os valores de cabeçalho da solicitação `:::no-loc(Cookie):::` .</span><span class="sxs-lookup"><span data-stu-id="36109-145"><xref:Microsoft.AspNetCore.Http.Features.IRequest:::no-loc(Cookie):::sFeature>: Parses and caches the request `:::no-loc(Cookie):::` header values.</span></span>

<span data-ttu-id="36109-146"><xref:Microsoft.AspNetCore.Http.Features.IResponse:::no-loc(Cookie):::sFeature>: Controla como :::no-loc(cookie)::: as respostas s são aplicadas ao `Set-:::no-loc(Cookie):::` cabeçalho.</span><span class="sxs-lookup"><span data-stu-id="36109-146"><xref:Microsoft.AspNetCore.Http.Features.IResponse:::no-loc(Cookie):::sFeature>: Controls how response :::no-loc(cookie):::s are applied to the `Set-:::no-loc(Cookie):::` header.</span></span>
