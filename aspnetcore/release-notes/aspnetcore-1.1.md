...
- [<span data-ttu-id="b5edd-109">:::no-loc(Cookie):::provedor TempData baseado em</span><span class="sxs-lookup"><span data-stu-id="b5edd-109">:::no-loc(Cookie):::-based TempData provider</span></span>](xref:fundamentals/app-state#tempdata)
