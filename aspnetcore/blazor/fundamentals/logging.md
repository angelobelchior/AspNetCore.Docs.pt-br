...
---
# <a name="aspnet-core-no-locblazor-logging"></a><span data-ttu-id="6a0a5-103">Log de ASP.NET Core Blazor</span><span class="sxs-lookup"><span data-stu-id="6a0a5-103">ASP.NET Core Blazor logging</span></span>

## Blazor WebAssembly

<span data-ttu-id="6a0a5-104">Configure o log em Blazor WebAssembly aplicativos com a `WebAssemblyHostBuilder.Logging` propriedade em `Program.Main` :</span><span class="sxs-lookup"><span data-stu-id="6a0a5-104">Configure logging in Blazor WebAssembly apps with the `WebAssemblyHostBuilder.Logging` property in `Program.Main`:</span></span>
...
## <a name="log-in-no-locrazor-components"></a><span data-ttu-id="6a0a5-113">Componentes de logon Razor</span><span class="sxs-lookup"><span data-stu-id="6a0a5-113">Log in Razor components</span></span>
...
<span data-ttu-id="6a0a5-116">O exemplo a seguir demonstra o registro em log com um <xref:Microsoft.Extensions.Logging.ILogger> nos Razor componentes do:</span><span class="sxs-lookup"><span data-stu-id="6a0a5-116">The following example demonstrates logging with an <xref:Microsoft.Extensions.Logging.ILogger> in Razor components:</span></span>
...
<span data-ttu-id="6a0a5-117">O exemplo a seguir demonstra o registro em log com um <xref:Microsoft.Extensions.Logging.ILoggerFactory> nos Razor componentes do:</span><span class="sxs-lookup"><span data-stu-id="6a0a5-117">The following example demonstrates logging with an <xref:Microsoft.Extensions.Logging.ILoggerFactory> in Razor components:</span></span>
