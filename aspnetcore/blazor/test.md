...
---
# <a name="test-components-in-aspnet-core-no-locblazor"></a><span data-ttu-id="645c5-103">Componentes de teste no ASP.NET Core Blazor</span><span class="sxs-lookup"><span data-stu-id="645c5-103">Test components in ASP.NET Core Blazor</span></span>
...
<span data-ttu-id="645c5-106">Para testar um Blazor componente, o *componente em teste* (recortar) é:</span><span class="sxs-lookup"><span data-stu-id="645c5-106">To test a Blazor component, the *Component Under Test* (CUT) is:</span></span>
...
<span data-ttu-id="645c5-112">Duas abordagens comuns para testar Blazor componentes são testes de E2E (ponta a ponta) e testes de unidade:</span><span class="sxs-lookup"><span data-stu-id="645c5-112">Two common approaches for testing Blazor components are end-to-end (E2E) testing and unit testing:</span></span>
...
* <span data-ttu-id="645c5-113">**Teste de unidade** : os [testes de unidade](/dotnet/core/testing/) são gravados com uma biblioteca de testes de unidade que fornece:</span><span class="sxs-lookup"><span data-stu-id="645c5-113">**Unit testing** : [Unit tests](/dotnet/core/testing/) are written with a unit testing library that provides:</span></span>
  ...
  * <span data-ttu-id="645c5-117">Asserções de que o comportamento do componente está correto.</span><span class="sxs-lookup"><span data-stu-id="645c5-117">Assertions that component behavior is correct.</span></span>
  ...
  <span data-ttu-id="645c5-118">[bUnit](https://github.com/egil/bUnit) é um exemplo de uma biblioteca que habilita o Razor teste de unidade de componente.</span><span class="sxs-lookup"><span data-stu-id="645c5-118">[bUnit](https://github.com/egil/bUnit) is an example of a library that enables Razor component unit testing.</span></span>

* <span data-ttu-id="645c5-119">**Teste de E2E** : um executor de teste executa um Blazor aplicativo que contém o recorte e automatiza uma instância do navegador.</span><span class="sxs-lookup"><span data-stu-id="645c5-119">**E2E testing** : A test runner runs a Blazor app containing the CUT and automates a browser instance.</span></span> <span data-ttu-id="645c5-120">A ferramenta de teste inspeciona e interage com o corte através do navegador.</span><span class="sxs-lookup"><span data-stu-id="645c5-120">The testing tool inspects and interacts with the CUT through the browser.</span></span> <span data-ttu-id="645c5-121">[Selenium](https://github.com/SeleniumHQ/selenium) é um exemplo de uma estrutura de teste do e2e que pode ser usada com Blazor aplicativos.</span><span class="sxs-lookup"><span data-stu-id="645c5-121">[Selenium](https://github.com/SeleniumHQ/selenium) is an example of an E2E testing framework that can be used with Blazor apps.</span></span>

<span data-ttu-id="645c5-122">No teste de unidade, apenas o Blazor componente ( Razor /c #) está envolvido.</span><span class="sxs-lookup"><span data-stu-id="645c5-122">In unit testing, only the Blazor component (Razor/C#) is involved.</span></span> <span data-ttu-id="645c5-123">Dependências externas, como os serviços e a interoperabilidade JS, devem ser simuladas.</span><span class="sxs-lookup"><span data-stu-id="645c5-123">External dependencies, such as services and JS interop, must be mocked.</span></span> <span data-ttu-id="645c5-124">No teste do E2E, o Blazor componente e toda a sua infraestrutura auxiliar fazem parte do teste, incluindo CSS, js e APIs de navegador e dom.</span><span class="sxs-lookup"><span data-stu-id="645c5-124">In E2E testing, the Blazor component and all of it's auxiliary infrastructure are part of the test, including CSS, JS, and the DOM and browser APIs.</span></span>
...
| -------------------------------- | -------------------------------- | --------------------------------------- |
| <span data-ttu-id="645c5-140">Escopo do teste</span><span class="sxs-lookup"><span data-stu-id="645c5-140">Test scope</span></span>                       | <span data-ttu-id="645c5-141">Blazor componente ( Razor apenas/c #)</span><span class="sxs-lookup"><span data-stu-id="645c5-141">Blazor component (Razor/C#) only</span></span> | <span data-ttu-id="645c5-142">Blazor componente ( Razor /c #) com CSS/JS</span><span class="sxs-lookup"><span data-stu-id="645c5-142">Blazor component (Razor/C#) with CSS/JS</span></span> |
...
| -------- | ------------------ | ------- |
| <span data-ttu-id="645c5-161">Componente sem lógica de interoperabilidade do JS</span><span class="sxs-lookup"><span data-stu-id="645c5-161">Component without JS interop logic</span></span> | <span data-ttu-id="645c5-162">Teste de unidade</span><span class="sxs-lookup"><span data-stu-id="645c5-162">Unit testing</span></span> | <span data-ttu-id="645c5-163">Quando não há nenhuma dependência na interoperabilidade do JS em um Blazor componente, o componente pode ser testado sem acesso ao js ou à API do dom.</span><span class="sxs-lookup"><span data-stu-id="645c5-163">When there's no dependency on JS interop in a Blazor component, the component can be tested without access to JS or the DOM API.</span></span> <span data-ttu-id="645c5-164">Nesse cenário, não há desvantagens em escolher o teste de unidade.</span><span class="sxs-lookup"><span data-stu-id="645c5-164">In this scenario, there are no disadvantages to choosing unit testing.</span></span> |
...
<span data-ttu-id="645c5-182">Não há uma estrutura de teste da Microsoft oficial para Blazor o, mas o projeto orientado pela Comunidade [bUnit](https://github.com/egil/bUnit) fornece uma maneira conveniente para componentes de teste de unidade Blazor .</span><span class="sxs-lookup"><span data-stu-id="645c5-182">There's no official Microsoft testing framework for Blazor, but the community-driven project [bUnit](https://github.com/egil/bUnit) provides a convenient way to unit test Blazor components.</span></span>
