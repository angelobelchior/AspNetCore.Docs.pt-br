---
title: 'Ferramentas para ASP.NET Core :::no-loc(Blazor):::'
author: guardrex
description: 'Saiba mais sobre as ferramentas disponíveis para criar :::no-loc(Blazor)::: aplicativos.'
...
---
# <a name="tooling-for-aspnet-core-no-locblazor"></a><span data-ttu-id="7ccac-103">Ferramentas para ASP.NET Core :::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="7ccac-103">Tooling for ASP.NET Core :::no-loc(Blazor):::</span></span>
...
1. <span data-ttu-id="7ccac-107">Selecione **:::no-loc(Blazor)::: aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-107">Select **:::no-loc(Blazor)::: App** .</span></span> <span data-ttu-id="7ccac-108">Selecione **Avançar** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-108">Select **Next** .</span></span>
...
1. <span data-ttu-id="7ccac-112">Para obter uma :::no-loc(Blazor WebAssembly)::: experiência, escolha o modelo de **:::no-loc(Blazor WebAssembly)::: aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-112">For a :::no-loc(Blazor WebAssembly)::: experience, choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="7ccac-113">Para obter uma :::no-loc(Blazor Server)::: experiência, escolha o modelo de **:::no-loc(Blazor Server)::: aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-113">For a :::no-loc(Blazor Server)::: experience, choose the **:::no-loc(Blazor Server)::: App** template.</span></span> <span data-ttu-id="7ccac-114">Selecione **Criar** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-114">Select **Create** .</span></span>

   <span data-ttu-id="7ccac-115">Para obter informações sobre os dois :::no-loc(Blazor)::: modelos de hospedagem *:::no-loc(Blazor WebAssembly):::* e *:::no-loc(Blazor Server):::* , consulte <xref:blazor/hosting-models> .</span><span class="sxs-lookup"><span data-stu-id="7ccac-115">For information on the two :::no-loc(Blazor)::: hosting models, *:::no-loc(Blazor WebAssembly):::* and *:::no-loc(Blazor Server):::* , see <xref:blazor/hosting-models>.</span></span>
...
1. <span data-ttu-id="7ccac-122">Para obter uma :::no-loc(Blazor WebAssembly)::: experiência, execute o seguinte comando em um shell de comando:</span><span class="sxs-lookup"><span data-stu-id="7ccac-122">For a :::no-loc(Blazor WebAssembly)::: experience, execute the following command in a command shell:</span></span>

   ```dotnetcli
   dotnet new blazorwasm -o WebApplication1
   ```

   <span data-ttu-id="7ccac-123">Para obter uma :::no-loc(Blazor Server)::: experiência, execute o seguinte comando em um shell de comando:</span><span class="sxs-lookup"><span data-stu-id="7ccac-123">For a :::no-loc(Blazor Server)::: experience, execute the following command in a command shell:</span></span>

   ```dotnetcli
   dotnet new blazorserver -o WebApplication1
   ```

   <span data-ttu-id="7ccac-124">Para obter informações sobre os dois :::no-loc(Blazor)::: modelos de hospedagem *:::no-loc(Blazor WebAssembly):::* e *:::no-loc(Blazor Server):::* , consulte <xref:blazor/hosting-models> .</span><span class="sxs-lookup"><span data-stu-id="7ccac-124">For information on the two :::no-loc(Blazor)::: hosting models, *:::no-loc(Blazor WebAssembly):::* and *:::no-loc(Blazor Server):::* , see <xref:blazor/hosting-models>.</span></span>
...
1. <span data-ttu-id="7ccac-138">Na barra lateral, selecione **aplicativo Web e de console**  >  **App** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-138">In the sidebar, select **Web and Console** > **App** .</span></span>
   ...
   <span data-ttu-id="7ccac-139">Para obter uma :::no-loc(Blazor WebAssembly)::: experiência, escolha o modelo de **:::no-loc(Blazor WebAssembly)::: aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-139">For a :::no-loc(Blazor WebAssembly)::: experience, choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="7ccac-140">Para obter uma :::no-loc(Blazor Server)::: experiência, escolha o modelo de **:::no-loc(Blazor Server)::: aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-140">For a :::no-loc(Blazor Server)::: experience, choose the **:::no-loc(Blazor Server)::: App** template.</span></span> <span data-ttu-id="7ccac-141">Selecione **Avançar** .</span><span class="sxs-lookup"><span data-stu-id="7ccac-141">Select **Next** .</span></span>

   <span data-ttu-id="7ccac-142">Para obter informações sobre os dois :::no-loc(Blazor)::: modelos de hospedagem *:::no-loc(Blazor WebAssembly):::* e *:::no-loc(Blazor Server):::* , consulte <xref:blazor/hosting-models> .</span><span class="sxs-lookup"><span data-stu-id="7ccac-142">For information on the two :::no-loc(Blazor)::: hosting models, *:::no-loc(Blazor WebAssembly):::* and *:::no-loc(Blazor Server):::* , see <xref:blazor/hosting-models>.</span></span>
