...
---
# <a name="aspnet-core-no-locblazor-event-handling"></a><span data-ttu-id="373e0-103">Manipulação de eventos de ASP.NET Core :::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="373e0-103">ASP.NET Core :::no-loc(Blazor)::: event handling</span></span>
