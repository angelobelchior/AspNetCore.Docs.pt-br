...
---
# <a name="aspnet-core-no-locblazor-lifecycle"></a><span data-ttu-id="9a744-103">:::no-loc(Blazor):::Ciclo de vida ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="9a744-103">ASP.NET Core :::no-loc(Blazor)::: lifecycle</span></span>
...
<span data-ttu-id="9a744-105">A :::no-loc(Blazor)::: estrutura inclui métodos de ciclo de vida síncronos e assíncronos.</span><span class="sxs-lookup"><span data-stu-id="9a744-105">The :::no-loc(Blazor)::: framework includes synchronous and asynchronous lifecycle methods.</span></span> <span data-ttu-id="9a744-106">Substitua métodos de ciclo de vida para executar operações adicionais em componentes durante a inicialização e a renderização do componente.</span><span class="sxs-lookup"><span data-stu-id="9a744-106">Override lifecycle methods to perform additional operations on components during component initialization and rendering.</span></span>

<span data-ttu-id="9a744-107">Os diagramas a seguir ilustram o :::no-loc(Blazor)::: ciclo de vida.</span><span class="sxs-lookup"><span data-stu-id="9a744-107">The following diagrams illustrate the :::no-loc(Blazor)::: lifecycle.</span></span> <span data-ttu-id="9a744-108">Os métodos de ciclo de vida são definidos com exemplos nas seções a seguir deste artigo.</span><span class="sxs-lookup"><span data-stu-id="9a744-108">Lifecycle methods are defined with examples in the following sections of this article.</span></span>
...
<span data-ttu-id="9a744-147">:::no-loc(Blazor Server)::: aplicativos que preparam [sua chamada de conteúdo](xref:blazor/fundamentals/additional-scenarios#render-mode) <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> **_duas vezes_** :</span><span class="sxs-lookup"><span data-stu-id="9a744-147">:::no-loc(Blazor Server)::: apps that [prerender their content](xref:blazor/fundamentals/additional-scenarios#render-mode) call <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> **_twice_** :</span></span>
...
<span data-ttu-id="9a744-202">No `FetchData` componente dos :::no-loc(Blazor)::: modelos, <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> é substituído para Asychronously receber dados de previsão ( `forecasts` ).</span><span class="sxs-lookup"><span data-stu-id="9a744-202">In the `FetchData` component of the :::no-loc(Blazor)::: templates, <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> is overridden to asychronously receive forecast data (`forecasts`).</span></span> <span data-ttu-id="9a744-203">Quando `forecasts` é `null` , uma mensagem de carregamento é exibida para o usuário.</span><span class="sxs-lookup"><span data-stu-id="9a744-203">When `forecasts` is `null`, a loading message is displayed to the user.</span></span> <span data-ttu-id="9a744-204">Depois que o `Task` retornado por <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> for concluído, o componente será rerenderizado com o estado atualizado.</span><span class="sxs-lookup"><span data-stu-id="9a744-204">After the `Task` returned by <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> completes, the component is rerendered with the updated state.</span></span>

<span data-ttu-id="9a744-205">`Pages/FetchData.razor` no :::no-loc(Blazor Server)::: modelo:</span><span class="sxs-lookup"><span data-stu-id="9a744-205">`Pages/FetchData.razor` in the :::no-loc(Blazor Server)::: template:</span></span>
...
<span data-ttu-id="9a744-215">Para evitar o cenário de processamento duplo em um :::no-loc(Blazor Server)::: aplicativo:</span><span class="sxs-lookup"><span data-stu-id="9a744-215">To avoid the double-rendering scenario in a :::no-loc(Blazor Server)::: app:</span></span>
