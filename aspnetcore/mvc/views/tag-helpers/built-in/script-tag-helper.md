...
<span data-ttu-id="b682c-109">A marcação a seguir Razor mostra um `script` elemento com um fallback:</span><span class="sxs-lookup"><span data-stu-id="b682c-109">The following Razor markup shows a `script` element with a fallback:</span></span>
