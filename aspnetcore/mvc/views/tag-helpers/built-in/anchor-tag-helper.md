...
#### <a name="usage-in-no-locrazor-pages"></a>Uso em Razor páginas

Razor As áreas de páginas têm suporte no ASP.NET Core 2,1 ou posterior.
...
> * Defina a propriedade [ Razor pagesoptions. AllowAreas](xref:Microsoft.AspNetCore.Mvc.RazorPages.RazorPagesOptions.AllowAreas*) como `true` :
>
