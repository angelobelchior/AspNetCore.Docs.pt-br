...
> [!WARNING]
> A tabela por tipo (TPT) não tem suporte pelo EF Core 3. x, mas foi implementada no [EF Core 5,0](https://docs.microsoft.com/ef/core/what-is-new/ef-core-5.0/plan).
