...
---
# <a name="part-6-no-locrazor-pages-with-ef-core-in-aspnet-core---read-related-data"></a><span data-ttu-id="3fe1a-103">Parte 6, Razor páginas com EF Core em dados relacionados à leitura de ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="3fe1a-103">Part 6, Razor Pages with EF Core in ASP.NET Core - Read Related Data</span></span>
...
<span data-ttu-id="3fe1a-442">Adicione a seguinte marcação ao final da página *páginas/instrutores/index. cshtml* Razor :</span><span class="sxs-lookup"><span data-stu-id="3fe1a-442">Add the following markup to the end of the *Pages/Instructors/Index.cshtml* Razor Page:</span></span>
