---
title: 'Métodos de filtro para :::no-loc(Razor)::: páginas no ASP.NET Core'
author: Rick-Anderson
description: 'Saiba como criar métodos de filtro para :::no-loc(Razor)::: páginas no ASP.NET Core.'
...
---
# <a name="filter-methods-for-no-locrazor-pages-in-aspnet-core"></a><span data-ttu-id="c5827-103">Métodos de filtro para :::no-loc(Razor)::: páginas no ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="c5827-103">Filter methods for :::no-loc(Razor)::: Pages in ASP.NET Core</span></span>
...
<span data-ttu-id="c5827-105">:::no-loc(Razor)::: Os filtros de página [IPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.ipagefilter?view=aspnetcore-2.0) e [IAsyncPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.iasyncpagefilter?view=aspnetcore-2.0) permitem que as :::no-loc(Razor)::: páginas executem o código antes e depois que um :::no-loc(Razor)::: manipulador de página é executado.</span><span class="sxs-lookup"><span data-stu-id="c5827-105">:::no-loc(Razor)::: Page filters [IPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.ipagefilter?view=aspnetcore-2.0) and [IAsyncPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.iasyncpagefilter?view=aspnetcore-2.0) allow :::no-loc(Razor)::: Pages to run code before and after a :::no-loc(Razor)::: Page handler is run.</span></span> <span data-ttu-id="c5827-106">:::no-loc(Razor)::: Os filtros de página são semelhantes aos [filtros de ação ASP.NET Core MVC](xref:mvc/controllers/filters#action-filters), exceto que não podem ser aplicados a métodos de manipuladores de páginas individuais.</span><span class="sxs-lookup"><span data-stu-id="c5827-106">:::no-loc(Razor)::: Page filters are similar to [ASP.NET Core MVC action filters](xref:mvc/controllers/filters#action-filters), except they can't be applied to individual page handler methods.</span></span>

<span data-ttu-id="c5827-107">:::no-loc(Razor)::: Filtros de página:</span><span class="sxs-lookup"><span data-stu-id="c5827-107">:::no-loc(Razor)::: Page filters:</span></span>
...
<span data-ttu-id="c5827-121">:::no-loc(Razor)::: Os filtros de página fornecem os seguintes métodos, que podem ser aplicados globalmente ou no nível de página:</span><span class="sxs-lookup"><span data-stu-id="c5827-121">:::no-loc(Razor)::: Page filters provide the following methods, which can be applied globally or at the page level:</span></span>
...
## <a name="implement-no-locrazor-page-filters-globally"></a><span data-ttu-id="c5827-134">Implementar :::no-loc(Razor)::: filtros de página globalmente</span><span class="sxs-lookup"><span data-stu-id="c5827-134">Implement :::no-loc(Razor)::: Page filters globally</span></span>
...
## <a name="implement-no-locrazor-page-filters-by-overriding-filter-methods"></a><span data-ttu-id="c5827-141">Implementar :::no-loc(Razor)::: filtros de página substituindo métodos de filtro</span><span class="sxs-lookup"><span data-stu-id="c5827-141">Implement :::no-loc(Razor)::: Page filters by overriding filter methods</span></span>

<span data-ttu-id="c5827-142">O código a seguir substitui os :::no-loc(Razor)::: filtros de página assíncrona:</span><span class="sxs-lookup"><span data-stu-id="c5827-142">The following code overrides the asynchronous :::no-loc(Razor)::: Page filters:</span></span>
...
<span data-ttu-id="c5827-154">:::no-loc(Razor)::: Os filtros de página [IPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.ipagefilter?view=aspnetcore-2.0) e [IAsyncPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.iasyncpagefilter?view=aspnetcore-2.0) permitem que as :::no-loc(Razor)::: páginas executem o código antes e depois que um :::no-loc(Razor)::: manipulador de página é executado.</span><span class="sxs-lookup"><span data-stu-id="c5827-154">:::no-loc(Razor)::: Page filters [IPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.ipagefilter?view=aspnetcore-2.0) and [IAsyncPageFilter](/dotnet/api/microsoft.aspnetcore.mvc.filters.iasyncpagefilter?view=aspnetcore-2.0) allow :::no-loc(Razor)::: Pages to run code before and after a :::no-loc(Razor)::: Page handler is run.</span></span> <span data-ttu-id="c5827-155">:::no-loc(Razor)::: Os filtros de página são semelhantes aos [filtros de ação ASP.NET Core MVC](xref:mvc/controllers/filters#action-filters), exceto que não podem ser aplicados a métodos de manipuladores de páginas individuais.</span><span class="sxs-lookup"><span data-stu-id="c5827-155">:::no-loc(Razor)::: Page filters are similar to [ASP.NET Core MVC action filters](xref:mvc/controllers/filters#action-filters), except they can't be applied to individual page handler methods.</span></span>

<span data-ttu-id="c5827-156">:::no-loc(Razor)::: Filtros de página:</span><span class="sxs-lookup"><span data-stu-id="c5827-156">:::no-loc(Razor)::: Page filters:</span></span>
...
<span data-ttu-id="c5827-166">:::no-loc(Razor)::: Os filtros de página fornecem os seguintes métodos, que podem ser aplicados globalmente ou no nível de página:</span><span class="sxs-lookup"><span data-stu-id="c5827-166">:::no-loc(Razor)::: Page filters provide the following methods, which can be applied globally or at the page level:</span></span>
...
## <a name="implement-no-locrazor-page-filters-globally"></a><span data-ttu-id="c5827-179">Implementar :::no-loc(Razor)::: filtros de página globalmente</span><span class="sxs-lookup"><span data-stu-id="c5827-179">Implement :::no-loc(Razor)::: Page filters globally</span></span>
...
## <a name="implement-no-locrazor-page-filters-by-overriding-filter-methods"></a><span data-ttu-id="c5827-188">Implementar :::no-loc(Razor)::: filtros de página substituindo métodos de filtro</span><span class="sxs-lookup"><span data-stu-id="c5827-188">Implement :::no-loc(Razor)::: Page filters by overriding filter methods</span></span>

<span data-ttu-id="c5827-189">O código a seguir substitui os :::no-loc(Razor)::: filtros de página síncrona:</span><span class="sxs-lookup"><span data-stu-id="c5827-189">The following code overrides the synchronous :::no-loc(Razor)::: Page filters:</span></span>
