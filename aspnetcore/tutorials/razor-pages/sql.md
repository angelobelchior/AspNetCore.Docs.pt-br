...
---
# <a name="part-4-of-tutorial-series-on-no-locrazor-pages"></a><span data-ttu-id="2cc3d-103">Parte 4 da série de tutoriais em Razor páginas</span><span class="sxs-lookup"><span data-stu-id="2cc3d-103">Part 4 of tutorial series on Razor Pages</span></span>
...
<span data-ttu-id="2cc3d-159">Create uma nova classe denominada `SeedData` na pasta *modelos* com o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="2cc3d-159">Create a new class named `SeedData` in the *Models* folder with the following code:</span></span>
...
<span data-ttu-id="2cc3d-182">Delete todos os registros no banco de dados, portanto, o método de semente será executado.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-182">Delete all the records in the database, so the seed method will run.</span></span> <span data-ttu-id="2cc3d-183">Interrompa e inicie o aplicativo para propagar o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-183">Stop and start the app to seed the database.</span></span>
...
> <span data-ttu-id="2cc3d-187">[Anterior: com Scaffold Razor Páginas](xref:tutorials/razor-pages/page) 
>  [seguinte: atualizar as páginas](xref:tutorials/razor-pages/da1)</span><span class="sxs-lookup"><span data-stu-id="2cc3d-187">[Previous: Scaffolded Razor Pages](xref:tutorials/razor-pages/page)
...
<span data-ttu-id="2cc3d-242">Create uma nova classe denominada `SeedData` na pasta *modelos* com o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="2cc3d-242">Create a new class named `SeedData` in the *Models* folder with the following code:</span></span>
...
* <span data-ttu-id="2cc3d-254">Delete todos os registros no banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-254">Delete all the records in the database.</span></span> <span data-ttu-id="2cc3d-255">Use os links de exclusão no navegador ou em [SSOX](xref:tutorials/razor-pages/new-field#ssox).</span><span class="sxs-lookup"><span data-stu-id="2cc3d-255">Use the delete links in the browser or from [SSOX](xref:tutorials/razor-pages/new-field#ssox).</span></span>
...
<span data-ttu-id="2cc3d-265">Delete todos os registros no banco de dados, portanto, o método de semente será executado.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-265">Delete all the records in the database, so the seed method will run.</span></span> <span data-ttu-id="2cc3d-266">Interrompa e inicie o aplicativo para propagar o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-266">Stop and start the app to seed the database.</span></span>
...
> [!div class="step-by-step"]
> <span data-ttu-id="2cc3d-270">[Anterior: com Scaffold Razor Páginas](xref:tutorials/razor-pages/page) 
>  [seguinte: atualizar as páginas](xref:tutorials/razor-pages/da1)</span><span class="sxs-lookup"><span data-stu-id="2cc3d-270">[Previous: Scaffolded Razor Pages](xref:tutorials/razor-pages/page)
[Next: Update the pages](xref:tutorials/razor-pages/da1)</span></span>
...
<span data-ttu-id="2cc3d-304">Create uma nova classe denominada `SeedData` na pasta *modelos* com o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="2cc3d-304">Create a new class named `SeedData` in the *Models* folder with the following code:</span></span>
...
* <span data-ttu-id="2cc3d-320">Delete todos os registros no banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-320">Delete all the records in the database.</span></span> <span data-ttu-id="2cc3d-321">Você pode fazer isso com os links de exclusão no navegador ou em [SSOX](xref:tutorials/razor-pages/new-field#ssox)</span><span class="sxs-lookup"><span data-stu-id="2cc3d-321">You can do this with the delete links in the browser or from [SSOX](xref:tutorials/razor-pages/new-field#ssox)</span></span>
...
<span data-ttu-id="2cc3d-331">Delete todos os registros no banco de dados, portanto, o método de semente será executado.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-331">Delete all the records in the database, so the seed method will run.</span></span> <span data-ttu-id="2cc3d-332">Interrompa e inicie o aplicativo para propagar o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-332">Stop and start the app to seed the database.</span></span>
...
<span data-ttu-id="2cc3d-334">Delete todos os registros no banco de dados, portanto, o método de semente será executado.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-334">Delete all the records in the database, so the seed method will run.</span></span> <span data-ttu-id="2cc3d-335">Interrompa e inicie o aplicativo para propagar o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="2cc3d-335">Stop and start the app to seed the database.</span></span>
...
> [!div class="step-by-step"]
> <span data-ttu-id="2cc3d-341">[Anterior: com Scaffold Razor Páginas](xref:tutorials/razor-pages/page) 
>  [seguinte: atualizar as páginas](xref:tutorials/razor-pages/da1)</span><span class="sxs-lookup"><span data-stu-id="2cc3d-341">[Previous: Scaffolded Razor Pages](xref:tutorials/razor-pages/page)
[Next: Update the pages](xref:tutorials/razor-pages/da1)</span></span>
