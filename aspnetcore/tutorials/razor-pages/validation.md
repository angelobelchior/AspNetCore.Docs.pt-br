...
---
# <a name="part-8-of-tutorial-series-on-no-locrazor-pages"></a><span data-ttu-id="7aa2b-103">Parte 8 da série de tutoriais em Razor páginas.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-103">Part 8 of tutorial series on Razor Pages.</span></span>
...
<span data-ttu-id="7aa2b-108">Um princípio-chave do desenvolvimento de software é chamado [DRY](https://wikipedia.org/wiki/Don%27t_repeat_yourself) (“ **D** on't **R** epeat **Y** ourself”).</span><span class="sxs-lookup"><span data-stu-id="7aa2b-108">A key tenet of software development is called [DRY](https://wikipedia.org/wiki/Don%27t_repeat_yourself) (" **D** on't **R** epeat **Y** ourself").</span></span> <span data-ttu-id="7aa2b-109">Razor As páginas incentivam o desenvolvimento onde a funcionalidade é especificada uma vez e é refletida em todo o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-109">Razor Pages encourages development where functionality is specified once, and it's reflected throughout the app.</span></span> <span data-ttu-id="7aa2b-110">O DRY pode ajudar a:</span><span class="sxs-lookup"><span data-stu-id="7aa2b-110">DRY can help:</span></span>
...
<span data-ttu-id="7aa2b-113">O suporte de validação fornecido por Razor páginas e Entity Framework é um bom exemplo do princípio seco:</span><span class="sxs-lookup"><span data-stu-id="7aa2b-113">The validation support provided by Razor Pages and Entity Framework is a good example of the DRY principle:</span></span>
...
### <a name="validation-error-ui-in-no-locrazor-pages"></a><span data-ttu-id="7aa2b-141">IU de erro de validação em Razor páginas</span><span class="sxs-lookup"><span data-stu-id="7aa2b-141">Validation Error UI in Razor Pages</span></span>
...
<span data-ttu-id="7aa2b-143">Selecione o link **Create novo** .</span><span class="sxs-lookup"><span data-stu-id="7aa2b-143">Select the **Create New** link.</span></span> <span data-ttu-id="7aa2b-144">Preencha o formulário com alguns valores inválidos.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-144">Complete the form with some invalid values.</span></span> <span data-ttu-id="7aa2b-145">Quando a validação do lado do cliente do jQuery detecta o erro, ela exibe uma mensagem de erro.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-145">When jQuery client-side validation detects the error, it displays an error message.</span></span>
...
* <span data-ttu-id="7aa2b-155">Coloque um ponto de interrupção no método `OnPostAsync`.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-155">Put a break point in the `OnPostAsync` method.</span></span> <span data-ttu-id="7aa2b-156">Envie o formulário selecionando **Create** ou **salvando**.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-156">Submit the form by selecting **Create** or **Save**.</span></span> <span data-ttu-id="7aa2b-157">O ponto de interrupção nunca é atingido.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-157">The break point is never hit.</span></span>
...
1. <span data-ttu-id="7aa2b-166">Defina um ponto de interrupção no `OnPostAsync` método da Create página ou edição.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-166">Set a break point in the `OnPostAsync` method of the Create or Edit page.</span></span>
...
<span data-ttu-id="7aa2b-170">O código a seguir mostra uma parte da página *Create . cshtml* com Scaffold anteriormente no tutorial.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-170">The following code shows a portion of the *Create.cshtml* page scaffolded earlier in the tutorial.</span></span> <span data-ttu-id="7aa2b-171">Ele é usado pelas Create páginas e editar para:</span><span class="sxs-lookup"><span data-stu-id="7aa2b-171">It's used by the Create and Edit pages to:</span></span>
...
<span data-ttu-id="7aa2b-177">As Create páginas e editar não têm nenhuma regra de validação.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-177">The Create and Edit pages have no validation rules in them.</span></span> <span data-ttu-id="7aa2b-178">As regras de validação e as cadeias de caracteres de erro são especificadas somente na classe `Movie`.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-178">The validation rules and the error strings are specified only in the `Movie` class.</span></span> <span data-ttu-id="7aa2b-179">Essas regras de validação são aplicadas automaticamente a Razor páginas que editam o `Movie` modelo.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-179">These validation rules are automatically applied to Razor Pages that edit the `Movie` model.</span></span>
...
<span data-ttu-id="7aa2b-221">[Introdução ao Razor As páginas e EF Core](xref:data/ef-rp/intro) mostram as operações de EF Core avançadas com Razor páginas.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-221">[Get started with Razor Pages and EF Core](xref:data/ef-rp/intro) shows advanced EF Core operations with Razor Pages.</span></span>
...
<span data-ttu-id="7aa2b-240">Obrigado por concluir esta introdução às Razor páginas.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-240">Thanks for completing this introduction to Razor Pages.</span></span> <span data-ttu-id="7aa2b-241">[Introdução ao Razor As páginas e EF Core](xref:data/ef-rp/intro) são um excelente acompanhamento deste tutorial.</span><span class="sxs-lookup"><span data-stu-id="7aa2b-241">[Get started with Razor Pages and EF Core](xref:data/ef-rp/intro) is an excellent follow up to this tutorial.</span></span>
