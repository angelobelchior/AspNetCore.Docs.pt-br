...
<span data-ttu-id="37bed-168">Adicione uma cadeia de conexão ao *:::no-loc(appsettings.json):::* arquivo:</span><span class="sxs-lookup"><span data-stu-id="37bed-168">Add a connection string to the *:::no-loc(appsettings.json):::* file:</span></span>
...
* <span data-ttu-id="37bed-188">:::no-loc(Razor)::: exibir arquivos para criar, excluir, detalhes, editar e indexar páginas ( *exibições/filmes/ \* . cshtml* )</span><span class="sxs-lookup"><span data-stu-id="37bed-188">:::no-loc(Razor)::: view files for Create, Delete, Details, Edit, and Index pages ( *Views/Movies/\*.cshtml* )</span></span>
...
<span data-ttu-id="37bed-345">Adicione uma cadeia de conexão ao *:::no-loc(appsettings.json):::* arquivo:</span><span class="sxs-lookup"><span data-stu-id="37bed-345">Add a connection string to the *:::no-loc(appsettings.json):::* file:</span></span>
...
* <span data-ttu-id="37bed-365">:::no-loc(Razor)::: exibir arquivos para criar, excluir, detalhes, editar e indexar páginas ( *exibições/filmes/ \* . cshtml* )</span><span class="sxs-lookup"><span data-stu-id="37bed-365">:::no-loc(Razor)::: view files for Create, Delete, Details, Edit, and Index pages ( *Views/Movies/\*.cshtml* )</span></span>
...
* <span data-ttu-id="37bed-491">:::no-loc(Razor)::: exibir arquivos para criar, excluir, detalhes, editar e indexar páginas ( *exibições/filmes/ \* . cshtml* )</span><span class="sxs-lookup"><span data-stu-id="37bed-491">:::no-loc(Razor)::: view files for Create, Delete, Details, Edit, and Index pages ( *Views/Movies/\*.cshtml* )</span></span>
