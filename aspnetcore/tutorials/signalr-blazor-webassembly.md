...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="963c0-103">Usar ASP.NET Core SignalR com Blazor WebAssembly</span><span class="sxs-lookup"><span data-stu-id="963c0-103">Use ASP.NET Core SignalR with Blazor WebAssembly</span></span>
...
<span data-ttu-id="963c0-105">Este tutorial ensina as noções básicas da criação de um aplicativo em tempo real usando o SignalR com o Blazor WebAssembly .</span><span class="sxs-lookup"><span data-stu-id="963c0-105">This tutorial teaches the basics of building a real-time app using SignalR with Blazor WebAssembly.</span></span> <span data-ttu-id="963c0-106">Você aprenderá como:</span><span class="sxs-lookup"><span data-stu-id="963c0-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="963c0-107">Criar um Blazor WebAssembly projeto de aplicativo hospedado</span><span class="sxs-lookup"><span data-stu-id="963c0-107">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="963c0-108">Adicionar a SignalR biblioteca de cliente</span><span class="sxs-lookup"><span data-stu-id="963c0-108">Add the SignalR client library</span></span>
> * <span data-ttu-id="963c0-109">Adicionar um SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-109">Add a SignalR hub</span></span>
> * <span data-ttu-id="963c0-110">Adicionar SignalR serviços e um ponto de extremidade para o SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-110">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="963c0-111">Adicionar Razor código de componente para o chat</span><span class="sxs-lookup"><span data-stu-id="963c0-111">Add Razor component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="963c0-127">Criar um Blazor WebAssembly projeto de aplicativo hospedado</span><span class="sxs-lookup"><span data-stu-id="963c0-127">Create a hosted Blazor WebAssembly app project</span></span>
...
1. <span data-ttu-id="963c0-133">Selecione **Blazor aplicativo** e selecione **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="963c0-133">Select **Blazor App** and select **Next**.</span></span>

1. <span data-ttu-id="963c0-134">Digite `BlazorSignalRApp` o campo **nome do projeto** .</span><span class="sxs-lookup"><span data-stu-id="963c0-134">Type `BlazorSignalRApp` in the **Project name** field.</span></span> <span data-ttu-id="963c0-135">Confirme se a entrada de **local** está correta ou forneça um local para o projeto.</span><span class="sxs-lookup"><span data-stu-id="963c0-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="963c0-136">Selecione **Criar**.</span><span class="sxs-lookup"><span data-stu-id="963c0-136">Select **Create**.</span></span>

1. <span data-ttu-id="963c0-137">Escolha o modelo de **Blazor WebAssembly aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="963c0-137">Choose the **Blazor WebAssembly App** template.</span></span>
...
1. <span data-ttu-id="963c0-149">Escolha o modelo de **Blazor WebAssembly aplicativo** .</span><span class="sxs-lookup"><span data-stu-id="963c0-149">Choose the **Blazor WebAssembly App** template.</span></span> <span data-ttu-id="963c0-150">Selecione **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="963c0-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="963c0-154">No campo **nome do projeto** , nomeie o aplicativo `BlazorSignalRApp` .</span><span class="sxs-lookup"><span data-stu-id="963c0-154">In the **Project Name** field, name the app `BlazorSignalRApp`.</span></span> <span data-ttu-id="963c0-155">Selecione **Criar**.</span><span class="sxs-lookup"><span data-stu-id="963c0-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="963c0-161">Adicionar a SignalR biblioteca de cliente</span><span class="sxs-lookup"><span data-stu-id="963c0-161">Add the SignalR client library</span></span>
...
1. <span data-ttu-id="963c0-163">Em **Gerenciador de soluções** , clique com o botão direito do mouse no `BlazorSignalRApp.Client` projeto e selecione **gerenciar pacotes NuGet**.</span><span class="sxs-lookup"><span data-stu-id="963c0-163">In **Solution Explorer** , right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="963c0-165">Com **procurar** selecionado, digite `Microsoft.AspNetCore.SignalR.Client` na caixa de pesquisa.</span><span class="sxs-lookup"><span data-stu-id="963c0-165">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="963c0-166">Nos resultados da pesquisa, selecione o [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) pacote e selecione **instalar**.</span><span class="sxs-lookup"><span data-stu-id="963c0-166">In the search results, select the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="963c0-172">Na barra lateral da **solução** , clique com o botão direito do mouse no `BlazorSignalRApp.Client` projeto e selecione **gerenciar pacotes NuGet**.</span><span class="sxs-lookup"><span data-stu-id="963c0-172">In the **Solution** sidebar, right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="963c0-174">Com **procurar** selecionado, digite `Microsoft.AspNetCore.SignalR.Client` na caixa de pesquisa.</span><span class="sxs-lookup"><span data-stu-id="963c0-174">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="963c0-175">Nos resultados da pesquisa, marque a caixa de seleção ao lado do [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) pacote e selecione **Adicionar pacote**.</span><span class="sxs-lookup"><span data-stu-id="963c0-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="963c0-179">Adicionar um SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-179">Add a SignalR hub</span></span>

<span data-ttu-id="963c0-180">No `BlazorSignalRApp.Server` projeto, crie uma `Hubs` pasta (plural) e adicione a seguinte `ChatHub` classe ( `Hubs/ChatHub.cs` ):</span><span class="sxs-lookup"><span data-stu-id="963c0-180">In the `BlazorSignalRApp.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="963c0-181">Adicionar serviços e um ponto de extremidade para o SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-181">Add services and an endpoint for the SignalR hub</span></span>

1. <span data-ttu-id="963c0-182">No projeto `BlazorSignalRApp.Server`, abra o arquivo `Startup.cs`.</span><span class="sxs-lookup"><span data-stu-id="963c0-182">In the `BlazorSignalRApp.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="963c0-184">Adicionar SignalR e responder aos serviços de middleware de compactação para `Startup.ConfigureServices` :</span><span class="sxs-lookup"><span data-stu-id="963c0-184">Add SignalR and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="963c0-188">Adicionar Razor código de componente para o chat</span><span class="sxs-lookup"><span data-stu-id="963c0-188">Add Razor component code for chat</span></span>

1. <span data-ttu-id="963c0-189">No projeto `BlazorSignalRApp.Client`, abra o arquivo `Pages/Index.razor`.</span><span class="sxs-lookup"><span data-stu-id="963c0-189">In the `BlazorSignalRApp.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="963c0-226">Criar um Blazor WebAssembly projeto de aplicativo hospedado</span><span class="sxs-lookup"><span data-stu-id="963c0-226">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="963c0-227">Adicionar a SignalR biblioteca de cliente</span><span class="sxs-lookup"><span data-stu-id="963c0-227">Add the SignalR client library</span></span>
> * <span data-ttu-id="963c0-228">Adicionar um SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-228">Add a SignalR hub</span></span>
> * <span data-ttu-id="963c0-229">Adicionar SignalR serviços e um ponto de extremidade para o SignalR Hub</span><span class="sxs-lookup"><span data-stu-id="963c0-229">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="963c0-230">Adicionar Razor código de componente para o chat</span><span class="sxs-lookup"><span data-stu-id="963c0-230">Add Razor component code for chat</span></span>

<span data-ttu-id="963c0-231">Para saber mais sobre a criação de Blazor aplicativos, consulte a Blazor documentação:</span><span class="sxs-lookup"><span data-stu-id="963c0-231">To learn more about building Blazor apps, see the Blazor documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="963c0-232"><xref:blazor/index>
> [Autenticação de token de portador com Identity eventos de servidor, WebSocket e Server-Sent](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="963c0-232"><xref:blazor/index>
...
* [<span data-ttu-id="963c0-234">SignalR negociação entre origens para autenticação</span><span class="sxs-lookup"><span data-stu-id="963c0-234">SignalR cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
