...
Cookie autenticação, estado de sessão e [vários outros componentes](https://docs.microsoft.com/aspnet/core/security/samesite?view=aspnetcore-3.0) definem suas opções de sameSite por meio Cookie de opções, por exemplo
