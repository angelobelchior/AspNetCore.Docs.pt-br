...
Cookie autenticação, estado de sessão e [vários outros componentes](../samesite.md?view=aspnetcore-2.1) definem suas opções de sameSite por meio Cookie de opções, por exemplo
