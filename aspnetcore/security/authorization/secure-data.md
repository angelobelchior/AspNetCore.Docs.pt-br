...
* <span data-ttu-id="7a089-484">Criar um :::no-loc(Razor)::: aplicativo de páginas chamado "ContactManager"</span><span class="sxs-lookup"><span data-stu-id="7a089-484">Create a :::no-loc(Razor)::: Pages app named "ContactManager"</span></span>
