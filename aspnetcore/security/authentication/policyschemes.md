...
<span data-ttu-id="e8c4a-104">Os esquemas de diretiva de autenticação facilitam a utilização de um único esquema de autenticação lógica, o que pode usar várias abordagens.</span><span class="sxs-lookup"><span data-stu-id="e8c4a-104">Authentication policy schemes make it easier to have a single logical authentication scheme potentially use multiple approaches.</span></span> <span data-ttu-id="e8c4a-105">Por exemplo, um esquema de política pode usar a autenticação do Google para desafios e a :::no-loc(cookie)::: autenticação para todo o resto.</span><span class="sxs-lookup"><span data-stu-id="e8c4a-105">For example, a policy scheme might use Google authentication for challenges, and :::no-loc(cookie)::: authentication for everything else.</span></span> <span data-ttu-id="e8c4a-106">Os esquemas de política de autenticação o fazem:</span><span class="sxs-lookup"><span data-stu-id="e8c4a-106">Authentication policy schemes make it:</span></span>
...
<span data-ttu-id="e8c4a-113">O exemplo a seguir mostra um esquema de nível superior que combina esquemas de nível inferior.</span><span class="sxs-lookup"><span data-stu-id="e8c4a-113">The following example shows a higher level scheme that combines lower level schemes.</span></span> <span data-ttu-id="e8c4a-114">A autenticação do Google é usada para desafios e a :::no-loc(cookie)::: autenticação é usada para tudo o mais:</span><span class="sxs-lookup"><span data-stu-id="e8c4a-114">Google authentication is used for challenges, and :::no-loc(cookie)::: authentication is used for everything else:</span></span>

[!code-csharp[sample](policyschemes/samples/Startup.cs?name=snippet1)]

<span data-ttu-id="e8c4a-115">O exemplo a seguir habilita a seleção dinâmica de esquemas de acordo com a solicitação.</span><span class="sxs-lookup"><span data-stu-id="e8c4a-115">The following example enables dynamic selection of schemes on a per request basis.</span></span> <span data-ttu-id="e8c4a-116">Ou seja, como misturar a :::no-loc(cookie)::: autenticação de s e de API:</span><span class="sxs-lookup"><span data-stu-id="e8c4a-116">That is, how to mix :::no-loc(cookie):::s and API authentication:</span></span>
