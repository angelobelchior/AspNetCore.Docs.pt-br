...
---
# <a name="add-download-and-delete-custom-user-data-to-no-locidentity-in-an-aspnet-core-project"></a><span data-ttu-id="1f917-104">Adicionar, baixar e excluir dados de usuário personalizados para Identity em um projeto ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="1f917-104">Add, download, and delete custom user data to Identity in an ASP.NET Core project</span></span>
...
* <span data-ttu-id="1f917-108">Marque o modelo de dados de usuário personalizado com o <xref:Microsoft.AspNetCore.Identity.PersonalDataAttribute> atributo para que ele seja automaticamente disponibilizado para download e exclusão.</span><span class="sxs-lookup"><span data-stu-id="1f917-108">Mark the custom user data model with the <xref:Microsoft.AspNetCore.Identity.PersonalDataAttribute> attribute so it's automatically available for download and deletion.</span></span> <span data-ttu-id="1f917-109">Tornar os dados capazes de ser baixados e excluídos ajuda a atender aos requisitos de [GDPR](xref:security/gdpr) .</span><span class="sxs-lookup"><span data-stu-id="1f917-109">Making the data able to be downloaded and deleted helps meet [GDPR](xref:security/gdpr) requirements.</span></span>

<span data-ttu-id="1f917-110">O exemplo de projeto é criado a partir de um Razor aplicativo Web de páginas, mas as instruções são semelhantes para um aplicativo web ASP.NET Core MVC.</span><span class="sxs-lookup"><span data-stu-id="1f917-110">The project sample is created from a Razor Pages web app, but the instructions are similar for a ASP.NET Core MVC web app.</span></span>
...
## <a name="create-a-no-locrazor-web-app"></a><span data-ttu-id="1f917-113">Criar um Razor aplicativo Web</span><span class="sxs-lookup"><span data-stu-id="1f917-113">Create a Razor web app</span></span>
...
## <a name="run-the-no-locidentity-scaffolder"></a><span data-ttu-id="1f917-128">Executar o Identity scaffolder</span><span class="sxs-lookup"><span data-stu-id="1f917-128">Run the Identity scaffolder</span></span>
...
* <span data-ttu-id="1f917-131">No painel esquerdo da caixa de diálogo **Adicionar Scaffold** , selecione **Identity**  >  **Adicionar** .</span><span class="sxs-lookup"><span data-stu-id="1f917-131">From the left pane of the **Add Scaffold** dialog, select **Identity** > **Add** .</span></span>
* <span data-ttu-id="1f917-132">Na caixa de diálogo **Adicionar Identity** , as seguintes opções:</span><span class="sxs-lookup"><span data-stu-id="1f917-132">In the **Add Identity** dialog, the following options:</span></span>
...
<span data-ttu-id="1f917-146">Execute o seguinte comando para listar as Identity Opções de scaffolder:</span><span class="sxs-lookup"><span data-stu-id="1f917-146">Run the following command to list the Identity scaffolder options:</span></span>

```dotnetcli
dotnet aspnet-codegenerator identity -h
```

<span data-ttu-id="1f917-147">Na pasta do projeto, execute o Identity scaffolder:</span><span class="sxs-lookup"><span data-stu-id="1f917-147">In the project folder, run the Identity scaffolder:</span></span>
...
## <a name="add-custom-user-data-to-the-no-locidentity-db"></a><span data-ttu-id="1f917-159">Adicionar dados de usuário personalizados ao Identity BD</span><span class="sxs-lookup"><span data-stu-id="1f917-159">Add custom user data to the Identity DB</span></span>

<span data-ttu-id="1f917-160">Atualize a `IdentityUser` classe derivada com propriedades personalizadas.</span><span class="sxs-lookup"><span data-stu-id="1f917-160">Update the `IdentityUser` derived class with custom properties.</span></span> <span data-ttu-id="1f917-161">Se você tiver nomeado o projeto WebApp1, o arquivo será chamado *áreas/ Identity /Data/WebApp1User.cs* .</span><span class="sxs-lookup"><span data-stu-id="1f917-161">If you named the project WebApp1, the file is named *Areas/Identity/Data/WebApp1User.cs* .</span></span> <span data-ttu-id="1f917-162">Atualize o arquivo com o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="1f917-162">Update the file with the following code:</span></span>
...
* <span data-ttu-id="1f917-164">Excluído quando a página *areas/ Identity /pages/Account/Manage/DeletePersonalData.cshtml* Razor chama `UserManager.Delete` .</span><span class="sxs-lookup"><span data-stu-id="1f917-164">Deleted when the *Areas/Identity/Pages/Account/Manage/DeletePersonalData.cshtml* Razor Page calls `UserManager.Delete`.</span></span>
* <span data-ttu-id="1f917-165">Incluídos nos dados baixados pela página *áreas/ Identity /pages/Account/Manage/DownloadPersonalData.cshtml* Razor .</span><span class="sxs-lookup"><span data-stu-id="1f917-165">Included in the downloaded data by the *Areas/Identity/Pages/Account/Manage/DownloadPersonalData.cshtml* Razor Page.</span></span>
...
<span data-ttu-id="1f917-167">Atualize o `InputModel` em *áreas/ Identity /pages/Account/Manage/index.cshtml.cs* com o seguinte código realçado:</span><span class="sxs-lookup"><span data-stu-id="1f917-167">Update the `InputModel` in *Areas/Identity/Pages/Account/Manage/Index.cshtml.cs* with the following highlighted code:</span></span>

::: moniker range=">= aspnetcore-3.0"

[!code-csharp[](add-user-data/samples/3.x/SampleApp/Areas/Identity/Pages/Account/Manage/Index.cshtml.cs?name=snippet&highlight=24-32,48-49,96-104,106)]

<span data-ttu-id="1f917-168">Atualize as *áreas/ Identity /pages/Account/Manage/index.cshtml* com a seguinte marcação realçada:</span><span class="sxs-lookup"><span data-stu-id="1f917-168">Update the *Areas/Identity/Pages/Account/Manage/Index.cshtml* with the following highlighted markup:</span></span>
...
<span data-ttu-id="1f917-169">Atualize as *áreas/ Identity /pages/Account/Manage/index.cshtml* com a seguinte marcação realçada:</span><span class="sxs-lookup"><span data-stu-id="1f917-169">Update the *Areas/Identity/Pages/Account/Manage/Index.cshtml* with the following highlighted markup:</span></span>
...
<span data-ttu-id="1f917-171">Atualize o `InputModel` em *áreas/ Identity /pages/Account/Register.cshtml.cs* com o seguinte código realçado:</span><span class="sxs-lookup"><span data-stu-id="1f917-171">Update the `InputModel` in *Areas/Identity/Pages/Account/Register.cshtml.cs* with the following highlighted code:</span></span>

::: moniker range=">= aspnetcore-3.0"

[!code-csharp[](add-user-data/samples/3.x/SampleApp/Areas/Identity/Pages/Account/Register.cshtml.cs?name=snippet&highlight=30-38,70-71)]

<span data-ttu-id="1f917-172">Atualize as *áreas/ Identity /pages/Account/Register.cshtml* com a seguinte marcação realçada:</span><span class="sxs-lookup"><span data-stu-id="1f917-172">Update the *Areas/Identity/Pages/Account/Register.cshtml* with the following highlighted markup:</span></span>
...
<span data-ttu-id="1f917-173">Atualize as *áreas/ Identity /pages/Account/Register.cshtml* com a seguinte marcação realçada:</span><span class="sxs-lookup"><span data-stu-id="1f917-173">Update the *Areas/Identity/Pages/Account/Register.cshtml* with the following highlighted markup:</span></span>
...
* <span data-ttu-id="1f917-182">Exiba os dados de usuário personalizados na `/Identity/Account/Manage` página.</span><span class="sxs-lookup"><span data-stu-id="1f917-182">View the custom user data on the `/Identity/Account/Manage` page.</span></span>
* <span data-ttu-id="1f917-183">Baixe e exiba os dados pessoais dos usuários na `/Identity/Account/Manage/PersonalData` página.</span><span class="sxs-lookup"><span data-stu-id="1f917-183">Download and view the users personal data from the `/Identity/Account/Manage/PersonalData` page.</span></span>

## <a name="add-claims-to-no-locidentity-using-iuserclaimsprincipalfactoryapplicationuser"></a><span data-ttu-id="1f917-184">Adicionar declarações ao Identity usando IUserClaimsPrincipalFactory<ApplicationUser></span><span class="sxs-lookup"><span data-stu-id="1f917-184">Add claims to Identity using IUserClaimsPrincipalFactory<ApplicationUser></span></span>
...
<span data-ttu-id="1f917-194">A declaração adicional pode ser usada no aplicativo.</span><span class="sxs-lookup"><span data-stu-id="1f917-194">The additional claim can then be used in the app.</span></span> <span data-ttu-id="1f917-195">Em uma Razor página, a `IAuthorizationService` instância pode ser usada para acessar o valor da declaração.</span><span class="sxs-lookup"><span data-stu-id="1f917-195">In a Razor Page, the `IAuthorizationService` instance can be used to access the claim value.</span></span>
