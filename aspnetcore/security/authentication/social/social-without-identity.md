...
---
# <a name="use-social-sign-in-provider-authentication-without-aspnet-core-no-locidentity"></a>Usar autenticação de provedor de entrada social sem ASP.NET CoreIdentity
