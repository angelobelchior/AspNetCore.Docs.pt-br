...
## <a name="use-ws-federation-without-aspnet-core-no-locidentity"></a>Usar o WS-Federation sem ASP.NET CoreIdentity
...
## <a name="add-ws-federation-as-an-external-login-provider-for-aspnet-core-no-locidentity"></a>Adicione o WS-Federation como um provedor de logon externo para ASP.NET CoreIdentity
