...
* <span data-ttu-id="62b53-134">:::no-loc(ASP.NET Core Identity)::: requer uma declaração de **ID de nome** .</span><span class="sxs-lookup"><span data-stu-id="62b53-134">:::no-loc(ASP.NET Core Identity)::: requires a **Name ID** claim.</span></span> <span data-ttu-id="62b53-135">Adicione um da caixa de diálogo **Editar regras de declaração** :</span><span class="sxs-lookup"><span data-stu-id="62b53-135">Add one from the **Edit Claim Rules** dialog:</span></span>
...
## <a name="use-ws-federation-without-no-locaspnet-core-identity"></a><span data-ttu-id="62b53-158">Usar WS-Federation sem :::no-loc(ASP.NET Core Identity):::</span><span class="sxs-lookup"><span data-stu-id="62b53-158">Use WS-Federation without :::no-loc(ASP.NET Core Identity):::</span></span>

<span data-ttu-id="62b53-159">O middleware WS-Federation pode ser usado sem :::no-loc(Identity)::: .</span><span class="sxs-lookup"><span data-stu-id="62b53-159">The WS-Federation middleware can be used without :::no-loc(Identity):::.</span></span> <span data-ttu-id="62b53-160">Por exemplo:</span><span class="sxs-lookup"><span data-stu-id="62b53-160">For example:</span></span>
...
## <a name="add-ws-federation-as-an-external-login-provider-for-no-locaspnet-core-identity"></a><span data-ttu-id="62b53-161">Adicionar WS-Federation como um provedor de logon externo para :::no-loc(ASP.NET Core Identity):::</span><span class="sxs-lookup"><span data-stu-id="62b53-161">Add WS-Federation as an external login provider for :::no-loc(ASP.NET Core Identity):::</span></span>
