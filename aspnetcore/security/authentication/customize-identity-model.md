...
---
# <a name="no-locidentity-model-customization-in-aspnet-core"></a>Identitypersonalização de modelo no ASP.NET Core
...
## <a name="no-locidentity-and-ef-core-migrations"></a>Identitye EF Core migrações
