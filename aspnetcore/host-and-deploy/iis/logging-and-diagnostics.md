...
Consulte [configuração com `web.config` ](xref:host-and-deploy/iis/web-config#configuration-with-webconfig) para obter um exemplo do `aspNetCore` elemento no `web.config` arquivo.
