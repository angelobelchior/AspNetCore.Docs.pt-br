...
---
# <a name="aspnet-core-no-locsignalr-supported-platforms"></a><span data-ttu-id="a40bd-103">ASP.NET Core :::no-loc(SignalR)::: plataformas com suporte</span><span class="sxs-lookup"><span data-stu-id="a40bd-103">ASP.NET Core :::no-loc(SignalR)::: supported platforms</span></span>
...
<span data-ttu-id="a40bd-105">:::no-loc(SignalR)::: para ASP.NET Core dá suporte a qualquer plataforma de servidor que ASP.NET Core suporte.</span><span class="sxs-lookup"><span data-stu-id="a40bd-105">:::no-loc(SignalR)::: for ASP.NET Core supports any server platform that ASP.NET Core supports.</span></span>
...
* <span data-ttu-id="a40bd-129">[Cliente C++](https://github.com/aspnet/:::no-loc(SignalR):::-Client-Cpp)</span><span class="sxs-lookup"><span data-stu-id="a40bd-129">[C++ client](https://github.com/aspnet/:::no-loc(SignalR):::-Client-Cpp)</span></span>

* <span data-ttu-id="a40bd-130">[Cliente Swift](https://github.com/moozzyk/:::no-loc(SignalR):::-Client-Swift)</span><span class="sxs-lookup"><span data-stu-id="a40bd-130">[Swift client](https://github.com/moozzyk/:::no-loc(SignalR):::-Client-Swift)</span></span>
